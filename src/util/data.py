...
class ScooterTrajectoriesDS:
    ...
    POS_ANALYSIS_COLS = [POS_COLS[0], POS_COLS[1], POS_COLS[2], POS_COLS[3], POS_COLS[4], POS_COLS[5], POS_COLS[6]]
    POS_2D_ANALYSIS_COUPLES = [(POS_COLS[1], POS_COLS[2])]
    ...
    RENTAL_2D_ANALYSIS_COUPLES = [(RENTAL_COLS[3], RENTAL_COLS[4]), (RENTAL_COLS[5], RENTAL_COLS[6])]
    ...
    DATASET_POS_OVER_RENTAL_ANALYSIS_TUPLE = (DATASET_POS_LATITUDE_CN, DATASET_POS_LONGITUDE_CN, DATASET_RENTAL_ID_CN)
    DATASET_POS_OVER_CLUSTER_ANALYSIS_TUPLE = (DATASET_POS_LATITUDE_CN, DATASET_POS_LONGITUDE_CN,
                                               DATASET_RENTAL_ID_CN, DATASET_CLUSTER_ID_CN)
